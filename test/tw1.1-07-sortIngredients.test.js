...
describe("TW1.1 sortIngredients", function tw1_1_30() {
    ...
    it("compareIngredientsCB compares by aisle, then by name", function tw1_1_30_0(){
        ...
        expect(compareIngredientsCB(ingredientsConst[0], ingredientsConst[1]), "if first aisle is bigger than second aisle, reverse order (return a positive number)").to.be.lt(0);
